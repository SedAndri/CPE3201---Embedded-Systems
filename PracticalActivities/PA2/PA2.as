...
;; *************** function _main *****************
;; Defined at:
;;		line 54 in file "Z:\CPE3201 - Bordario\PracticalActivities\PA2\PA2-1.c"
...
psect	maintext,global,class=CODE,delta=2,split=1
	file	"Z:\CPE3201 - Bordario\PracticalActivities\PA2\PA2-1.c"
	line	54
global __pmaintext
...
l514:	
;PA2-1.c: 56: TRISB = 0x00;
	bsf	status, 5	;RP0=1, select bank1
	bcf	status, 6	;RP1=0, select bank1
	clrf	(134)^080h	;volatile
	line	57
;PA2-1.c: 57: TRISC = 0x00;
	clrf	(135)^080h	;volatile
	line	59
;PA2-1.c: 59: PORTB = 0x00;
	bcf	status, 5	;RP0=0, select bank0
	bcf	status, 6	;RP1=0, select bank0
	clrf	(6)	;volatile
	line	60
;PA2-1.c: 60: PORTC = 0x00;
	clrf	(7)	;volatile
	line	62
...
l518:	
;PA2-1.c: 65: instCtrl(0xC6);
	movlw	(0C6h)
	fcall	_instCtrl
	line	67
	
l520:	
;PA2-1.c: 67: dataCtrl('H');
	movlw	(048h)
	fcall	_dataCtrl
	line	68
	
l522:	
;PA2-1.c: 68: dataCtrl('E');
	movlw	(045h)
	fcall	_dataCtrl
	line	69
	
l524:	
;PA2-1.c: 69: dataCtrl('L');
	movlw	(04Ch)
	fcall	_dataCtrl
	line	70
	
l526:	
;PA2-1.c: 70: dataCtrl('L');
	movlw	(04Ch)
	fcall	_dataCtrl
	line	71
	
l528:	
;PA2-1.c: 71: dataCtrl('O');
	movlw	(04Fh)
	fcall	_dataCtrl
	line	72
...
;; *************** function _initLCD *****************
;; Defined at:
;;		line 42 in file "Z:\CPE3201 - Bordario\PracticalActivities\PA2\PA2-1.c"
;; Parameters:    Size  Location     Type
;;		None
;; Auto vars:     Size  Location     Type
;;		None
...
;PA2-1.c: 44: delay_ms(20);
	...
	fcall	_delay_ms
	line	46
;PA2-1.c: 46: instCtrl(0x38);
	movlw	(038h)
	fcall	_instCtrl
	line	47
;PA2-1.c: 47: instCtrl(0x08);
	movlw	(08h)
	fcall	_instCtrl
	line	48
;PA2-1.c: 48: instCtrl(0x01);
	movlw	(01h)
	fcall	_instCtrl
	line	49
;PA2-1.c: 49: delay_ms(2);
	movlw	low(02h)
	movwf	(delay_ms@ms)
	movlw	high(02h)
	movwf	((delay_ms@ms))+1
	fcall	_delay_ms
	line	50
;PA2-1.c: 50: instCtrl(0x06);
	movlw	(06h)
	fcall	_instCtrl
	line	51
;PA2-1.c: 51: instCtrl(0x0E);
	movlw	(0Eh)
	fcall	_instCtrl
	line	52
...
;; *************** function _instCtrl *****************
;; Defined at:
;;		line 24 in file "Z:\CPE3201 - Bordario\PracticalActivities\PA2\PA2-1.c"
;; Parameters:    Size  Location     Type
...
;PA2-1.c: 28: RC1 = 1;
	...
	line	29
;PA2-1.c: 29: _delay((unsigned long)((2)*(20000000/4000.0)));
	opt asmopt_off
movlw	13
...
;; *************** function _delay_ms *****************
;; Defined at:
;;		line 18 in file "Z:\CPE3201 - Bordario\PracticalActivities\PA2\PA2-1.c"
;; Parameters:    Size  Location     Type
...
l494:	
;PA2-1.c: 21: _delay((unsigned long)((1)*(20000000/4000.0)));
	opt asmopt_off
movlw	7
...
;; *************** function _dataCtrl *****************
;; Defined at:
;;		line 33 in file "Z:\CPE3201 - Bordario\PracticalActivities\PA2\PA2-1.c"
;; Parameters:    Size  Location     Type
...
;PA2-1.c: 37: RC1 = 1;
	bsf	(57/8),(57)&7	;volatile
	line	38
;PA2-1.c: 38: _delay((unsigned long)((2)*(20000000/4000.0)));
	opt asmopt_off
movlw	13
